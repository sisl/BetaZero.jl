...
alpha_over_time(solver::BetaZeroSolver, apply_func::Function=mean) = x_over_time(solver, :alpha, apply_func)
alpha_over_time(metrics::Vector, apply_func::Function=mean; N) = x_over_time(metrics, :alpha, apply_func; N=N)
