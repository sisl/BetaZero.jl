...
"""
    estimate_policy(estimator, mdp, state)

Return an estimate of the policy.
"""
function estimate_policy end
estimate_policy(f::Function, mdp::Union{POMDP,MDP}, state) = f(mdp, state)
